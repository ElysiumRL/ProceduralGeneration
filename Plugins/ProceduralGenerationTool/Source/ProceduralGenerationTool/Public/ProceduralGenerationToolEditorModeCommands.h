 ...
 */
class FProceduralGenerationToolEditorModeCommands : public TCommands<FProceduralGenerationToolEditorModeCommands>
{
public:
	FProceduralGenerationToolEditorModeCommands();
	...
	TSharedPtr<FUICommandInfo> TagManager;
