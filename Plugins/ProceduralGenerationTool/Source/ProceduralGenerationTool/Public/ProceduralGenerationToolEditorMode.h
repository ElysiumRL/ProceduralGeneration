...
#include "ProceduralGenerationToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UProceduralGenerationToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ProceduralGenerationToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;
	static FString PSRName;
	static FString TagManagerName;
