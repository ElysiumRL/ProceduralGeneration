...
#include "ProceduralGenerationToolSimpleTool.h"
...
#define LOCTEXT_NAMESPACE "ProceduralGenerationToolSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UProceduralGenerationToolSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UProceduralGenerationToolSimpleTool* NewTool = NewObject<UProceduralGenerationToolSimpleTool>(SceneState.ToolManager);
