...
#include "ProceduralGenerationToolInteractiveTool.generated.h"


/**
 * Builder for UProceduralGenerationToolInteractiveTool
 */
UCLASS()
class PROCEDURALGENERATIONTOOL_API UProceduralGenerationToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UProceduralGenerationToolInteractiveTool
 */
UCLASS(Transient)
class PROCEDURALGENERATIONTOOL_API UProceduralGenerationToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UProceduralGenerationToolInteractiveToolProperties();
...
/**
 * UProceduralGenerationToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PROCEDURALGENERATIONTOOL_API UProceduralGenerationToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UProceduralGenerationToolInteractiveToolProperties> Properties;
