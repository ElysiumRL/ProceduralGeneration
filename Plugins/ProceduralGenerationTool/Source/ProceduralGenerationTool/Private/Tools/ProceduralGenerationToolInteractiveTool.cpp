...
#include "ProceduralGenerationToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UProceduralGenerationToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UProceduralGenerationToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UProceduralGenerationToolInteractiveTool* NewTool = NewObject<UProceduralGenerationToolInteractiveTool>(SceneState.ToolManager);
...
UProceduralGenerationToolInteractiveToolProperties::UProceduralGenerationToolInteractiveToolProperties()
{
...
void UProceduralGenerationToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UProceduralGenerationToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UProceduralGenerationToolInteractiveToolProperties>(this, "Measurement");
...
void UProceduralGenerationToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UProceduralGenerationToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UProceduralGenerationToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UProceduralGenerationToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UProceduralGenerationToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UProceduralGenerationToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UProceduralGenerationToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UProceduralGenerationToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UProceduralGenerationToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
